...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/download/Capstone2/Hotel Ava/.opencode/.gsd-surface.json`
(sibling to `D:/download/Capstone2/Hotel Ava/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/download/Capstone2/Hotel Ava/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`D:/download/Capstone2/Hotel Ava/.opencode/skills`).
...
`D:/download/Capstone2/Hotel Ava/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/download/Capstone2/Hotel Ava/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/download/Capstone2/Hotel Ava/.opencode/.gsd-surface.json`
Install profile marker: `D:/download/Capstone2/Hotel Ava/.opencode/.gsd-profile`
Skill dirs: `D:/download/Capstone2/Hotel Ava/.opencode/skills/gsd-*/`
Engine module: `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
