...
INSTALL_JS_GLOBAL="D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
