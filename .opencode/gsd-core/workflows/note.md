...
- **Global scope**: `D:/download/Capstone2/Hotel Ava/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/download/Capstone2/Hotel Ava/.opencode/notes/`)
...
2. Glob `D:/download/Capstone2/Hotel Ava/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (D:/download/Capstone2/Hotel Ava/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/download/Capstone2/Hotel Ava/.opencode/notes/` — works in any directory
