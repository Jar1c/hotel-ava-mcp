...
```markdown
Read D:/download/Capstone2/Hotel Ava/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/download/Capstone2/Hotel Ava/.opencode/agents/gsd-ui-checker.md for instructions.
