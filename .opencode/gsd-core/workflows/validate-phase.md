...
```
Agent(
  prompt="Read D:/download/Capstone2/Hotel Ava/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/templates/VALIDATION.md`
