...
ones). Reference: @D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/download/Capstone2/Hotel Ava/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/download/Capstone2/Hotel Ava/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/templates/spec.md.
