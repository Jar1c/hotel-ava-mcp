...
<required_reading>
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/user-story-template.md
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/spidr-splitting.md
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:
