...
<!-- For checkpoint task examples and patterns, see @D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/checkpoints.md -->
...
See `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
