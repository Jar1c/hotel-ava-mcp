...
<required_reading>
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/verification-overrides.md
...
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@D:/download/Capstone2/Hotel Ava/.opencode/gsd-core/references/verify-mvp-mode.md`.
