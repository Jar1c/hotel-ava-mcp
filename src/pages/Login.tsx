          ...
          {mode === "choose" && (
            <>
              ...
              <Button
                ...
                variant="outline"
                className="w-full py-2.5 font-medium !rounded-[10px] border-hairline text-ink hover:bg-surface-soft transition-colors"
              >
          ...
          {mode === "email" && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm text-muted hover:text-ink transition-colors mb-5 cursor-pointer"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="15 18 9 12 15 6" />
                </svg>
